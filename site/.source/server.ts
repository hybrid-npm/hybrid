...
import * as __fd_glob_19 from "../content/docs/blockchain/multi-chain.md?collection=docs"
import * as __fd_glob_18 from "../content/docs/blockchain/foundry.md?collection=docs"
import * as __fd_glob_17 from "../content/docs/developing/framework.md?collection=docs"
import * as __fd_glob_16 from "../content/docs/developing/contributing.md?collection=docs"
...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, "agent/meta.json": __fd_glob_1, "blockchain/meta.json": __fd_glob_2, "developing/meta.json": __fd_glob_3, "howto/meta.json": __fd_glob_4, "tools/meta.json": __fd_glob_5, }, {"core-concepts.md": __fd_glob_6, "index.mdx": __fd_glob_7, "quickstart.md": __fd_glob_8, "tools.md": __fd_glob_9, "using-hybrid.md": __fd_glob_10, "agent/behaviors.md": __fd_glob_11, "agent/error-handling.md": __fd_glob_12, "agent/models.md": __fd_glob_13, "agent/prompts.md": __fd_glob_14, "agent/runtime.md": __fd_glob_15, "developing/contributing.md": __fd_glob_16, "developing/framework.md": __fd_glob_17, "blockchain/foundry.md": __fd_glob_18, "blockchain/multi-chain.md": __fd_glob_19, "howto/mini-apps.md": __fd_glob_20, "tools/blockchain.md": __fd_glob_21, "tools/index.md": __fd_glob_22, "tools/xmtp.md": __fd_glob_23, });